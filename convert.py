...
with open('import/ml-1m/movies.dat', encoding='latin-1') as f_in, \
...
with open('import/ml-1m/ratings.dat', encoding='latin-1') as f_in, \
...
with open('import/ml-1m/users.dat', encoding='latin-1') as f_in, \
